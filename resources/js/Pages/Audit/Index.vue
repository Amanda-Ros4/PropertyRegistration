...
<template>
    <AppLayout :title="trans('audit.title')">
        ...
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <!-- Card dos Filtros encapsulado em sua própria div, igual a Usuários -->
            <div
            ...
            <!-- Card da Tabela atualizado para usar as cores slate -->
            <div
                ...
                <template v-else>
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            <thead
                                class="bg-slate-50 dark:bg-slate-950/50 border-b border-slate-100 dark:border-slate-800">
                                <tr>
                                    <th
                                        class="px-4 py-3 text-left font-semibold text-slate-600 dark:text-slate-300 w-20">
                                    ...
                                    <th
                                        class="px-4 py-3 text-left font-semibold text-slate-600 dark:text-slate-300 w-36">
                                        {{ trans('audit.fields.event') }}
                                    </th>
                                    <th
                                        class="px-4 py-3 text-left font-semibold text-slate-600 dark:text-slate-300 w-44">
                                    ...
                                    <th
                                        class="px-4 py-3 text-left font-semibold text-slate-600 dark:text-slate-300 w-28">
                                        {{ trans('audit.fields.audited_id') }}
                                    </th>
                                    <th
                                        class="py-3 text-right font-semibold text-slate-600 dark:text-slate-300 w-24">
                                        <span class="mr-1">{{ trans('audit.fields.details') }}</span>
                                    </th>
                                </tr>
                            </thead>
