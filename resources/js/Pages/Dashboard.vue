    ...
    <AppLayout :title="trans('dashboard.title')">
        ...
        <div class="space-y-6 max-w-7xl mx-auto">
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <div class="flex-1 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm">
                    ...
                    <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">{{ trans('dashboard.description') }}</p>
                ...
                <!-- Caixa de Resumo Operacional da direita (com largura adaptável no desktop) -->
                <div class="w-full lg:w-[380px] shrink-0 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm">
