                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <FormField class="md:col-span-3" :label="trans('properties.fields.owner')"
                            ...
                            <AppSelect v-model="form.person_id" :options="peopleOptions"
                                :placeholder="trans('properties.placeholders.owner')" :invalid="!!form.errors.person_id"
                                filter class="w-full"
                        ...
                        <FormField class="md:col-span-1" :label="trans('properties.fields.type')"
                            ...
                            <AppSelect v-model="form.type" :options="typeOptions"
                                :placeholder="trans('properties.placeholders.type')" :invalid="!!form.errors.type"
                                class="w-full"
                        ...
                        <FormField class="md:col-span-1" :label="trans('properties.fields.cep')"
                            ...
                            <div class="relative">
                                <Input :model-value="form.cep" type="text" inputmode="numeric"
                                    autocomplete="postal-code" :placeholder="trans('properties.placeholders.cep')"
                                    :class="cn('w-full pr-10', (form.errors.cep || cepLookupError) && 'border-destructive')"
                                    :maxlength="CEP_INPUT_MAX_LENGTH" :disabled="cepLoading"
                                    @update:model-value="onCepInput" @blur="validateField('cep')"
                                    @change="form.clearErrors('cep')" />
                                <Loader2 v-show="cepLoading"
                                    class="absolute right-3 top-1/2 size-4 -translate-y-1/2 animate-spin text-slate-400 pointer-events-none"
                                    aria-hidden="true" />
                            </div>
                        </FormField>

                        <FormField class="md:col-span-2" :label="trans('properties.fields.street')"
                            :error="form.errors.street" required>
                            <div @keydown.capture="blockDisallowedAddressKey"
                                @beforeinput.capture="blockDisallowedAddressBeforeInput">
                                <Input :model-value="form.street" :placeholder="trans('properties.placeholders.street')"
                                    :class="cn('w-full', form.errors.street && 'border-destructive')" :maxlength="60"
                                    @update:model-value="onStreetInput" @blur="validateField('street')"
                        ...
                        <FormField class="md:col-span-2" :label="trans('properties.fields.neighborhood')"
                            :error="form.errors.neighborhood" required>
                            <div @keydown.capture="blockDisallowedAddressKey"
                                @beforeinput.capture="blockDisallowedAddressBeforeInput">
                                <Input :model-value="form.neighborhood"
                                    :placeholder="trans('properties.placeholders.neighborhood')"
                                    :class="cn('w-full', form.errors.neighborhood && 'border-destructive')"
                                    :maxlength="60" @update:model-value="onNeighborhoodInput"
                                    @blur="validateField('neighborhood')" @change="form.clearErrors('neighborhood')" />
                            </div>
                        </FormField>
                        ...
                        <FormField class="md:col-span-3" :label="trans('properties.fields.complement')"
                            ...
                            <div @keydown.capture="blockDisallowedAddressKey"
                                @beforeinput.capture="blockDisallowedAddressBeforeInput">
                                <Input :model-value="form.complement"
                                    :placeholder="trans('properties.placeholders.complement')"
                                    :class="cn('w-full', form.errors.complement && 'border-destructive')"
                                    :maxlength="60" @update:model-value="onComplementInput"
                                    @blur="validateField('complement')" @change="form.clearErrors('complement')" />
                            </div>
                        </FormField>
