            ...
            <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
                <section class="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-6 items-stretch">
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 sm:p-10 shadow-sm">
                        <div class="max-w-3xl">
                            <p class="text-sm font-semibold uppercase tracking-[0.2em] text-amber-700 dark:text-amber-400 mb-4">
                                {{ trans('welcome.badge') }}
                            </p>
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm p-6 sm:p-8">
                        <div class="flex items-center gap-3 mb-6">
                            <div class="w-12 h-12 rounded-xl bg-amber-50 dark:bg-amber-950/20 flex items-center justify-center">
                                <i class="pi pi-chart-bar text-amber-600 dark:text-amber-400 text-xl" />
                            </div>
                            <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="rounded-xl border border-amber-200 dark:border-amber-900/40 bg-amber-50 dark:bg-amber-950/20 p-4">
                                <p class="text-sm font-semibold text-amber-800 dark:text-amber-300 mb-1">{{ trans('welcome.audience_title') }}</p>
                                <p class="text-sm text-amber-800/90 dark:text-amber-200">{{ trans('welcome.audience_description') }}</p>
                            </div>
                        </div>
                    </div>
                </section>
