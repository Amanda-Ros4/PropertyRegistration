...
<template>
    <ActionSection>
        <template #title>
            {{ trans('profile.two_factor.title') }}
        </template>
        ...
        <template #content>
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                <p>
                    {{ trans('profile.two_factor.prompt_info') }}
                </p>
            </div>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p v-if="confirming" class="font-semibold">
                            {{ trans('profile.two_factor.scan_to_finish') }}
                        </p>

                        <p v-else>
                            {{ trans('profile.two_factor.scan_enabled') }}
                        </p>
                    </div>
                    ...
                    <div v-if="setupKey" class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p class="font-semibold">
                            {{ trans('profile.two_factor.setup_key') }}: <span v-html="setupKey"></span>
                        </p>
                    </div>

                    <div v-if="confirming" class="mt-4">
                        <InputLabel for="code" :value="trans('profile.two_factor.code')" />
                ...
                <div v-if="recoveryCodes.length > 0 && ! confirming">
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p class="font-semibold">
                            {{ trans('profile.two_factor.recovery_codes_info') }}
                        </p>
                    </div>

                    <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 text-sm bg-gray-100 dark:bg-gray-800 rounded-lg">
            ...
            <div class="mt-5">
                <div v-if="! twoFactorEnabled">
                    <ConfirmsPassword @confirmed="enableTwoFactorAuthentication">
                        <PrimaryButton type="button" :class="{ 'opacity-25': enabling }" :disabled="enabling">
                            {{ trans('profile.two_factor.enable') }}
                        </PrimaryButton>
                    </ConfirmsPassword>
                </div>
                ...
                <div v-else>
                    <ConfirmsPassword @confirmed="confirmTwoFactorAuthentication">
                        ...
                        >
                            {{ trans('profile.two_factor.confirm') }}
                        </PrimaryButton>
                    </ConfirmsPassword>
                    ...
                    <ConfirmsPassword @confirmed="regenerateRecoveryCodes">
                        <SecondaryButton
                            ...
                            class="me-3"
                        >
                            {{ trans('profile.two_factor.regenerate_codes') }}
                        </SecondaryButton>
                    </ConfirmsPassword>
                    ...
                    <ConfirmsPassword @confirmed="showRecoveryCodes">
                        <SecondaryButton
                            ...
                            class="me-3"
                        >
                            {{ trans('profile.two_factor.show_codes') }}
                        </SecondaryButton>
                    </ConfirmsPassword>
